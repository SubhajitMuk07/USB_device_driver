...
//  kmalloc can fail. kzalloc zeroes the memory before returning a pointer
...
dev_info(&interface->dev,"USB device now attached to  driver-%d",interface->minor);
return 0;
